...
const DEFAULT_TITLE = 'Wi-Fi Home Network Diagnostics';
    ...
    <header className="sticky top-0 z-10 flex flex-col border-b bg-background">
      ...
      <div className="flex items-center justify-between gap-3 px-3 py-2">
        <div className="flex items-center gap-3">
          <SidebarToggle />
          <img src={AirtiesLogo} alt="Airties" className="h-7" />
        </div>
        <div className="flex items-center gap-2">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                type="button"
                className="flex size-8 items-center justify-center rounded-full bg-accent text-[12px] font-bold text-[var(--primary)] hover:opacity-90"
