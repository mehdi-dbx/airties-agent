...
const CHECKLIST_TRIGGER_MESSAGE = 'Show the network diagnostics';
...
function PureMessages({
  ...
  return (
    <div
      ...
      className="overscroll-behavior-contain -webkit-overflow-scrolling-touch min-h-0 flex-1 touch-pan-y overflow-y-scroll"
