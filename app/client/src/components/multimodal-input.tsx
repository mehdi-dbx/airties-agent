...
function PureMultimodalInput({
  ...
  return (
    <div className="relative flex w-full flex-col gap-4">
      ...
      <PromptInput
        className="rounded-xl border border-border bg-card p-3 shadow-sm transition-all duration-200 focus-within:border-[var(--primary)] focus-within:ring-1 focus-within:ring-[var(--primary)]"
        onSubmit={(event) => {
          event.preventDefault();
          if (status !== 'ready') {
        ...
        <div className="flex items-center gap-2">
          ...
          {(voiceState === 'listening' ||
            ...
            <PromptInputSubmit
              ...
              className="size-8 shrink-0 rounded-xl bg-[var(--primary)] text-white transition-colors duration-200 hover:bg-[#2222B8] disabled:bg-muted disabled:text-muted-foreground disabled:cursor-not-allowed"
            >
              <ArrowRight size={14} />
            </PromptInputSubmit>
          )}
