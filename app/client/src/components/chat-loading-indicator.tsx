...
const TOOL_MESSAGES: Record<string, string> = {
  diagnose_wifi: 'Diagnosing Wi-Fi network',
  check_mesh_status: 'Checking mesh node status',
  query_network_health: 'Analyzing network health',
  query_client_devices: 'Scanning connected devices',
  run_speed_test: 'Running speed test',
  check_channel_interference: 'Checking channel interference',
  optimize_band_steering: 'Optimizing band steering',
  query_wifi_events: 'Loading Wi-Fi events',
  check_signal_strength: 'Measuring signal strength',
  update_node_config: 'Updating node configuration',
  query_coverage_map: 'Mapping coverage areas',
